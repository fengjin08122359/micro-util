...
exports.default = function () {
  ...
  if (window.WEB_SOCKET_LOGGER) {
    logger = window.WEB_SOCKET_LOGGER;
  ...
  if (_swfobject2.default.getFlashPlayerVersion().major < 10) {
  ...
  WebSocket.__initialize = function () {
    ...
    if (!window.WEB_SOCKET_SUPPRESS_CROSS_DOMAIN_SWF_ERROR && !window.WEB_SOCKET_SWF_LOCATION.match(/(^|\/)WebSocketMainInsecure\.swf(\?.*)?$/) && window.WEB_SOCKET_SWF_LOCATION.match(/^\w+:\/\/([^\/]+)/)) {
    ...
    _swfobject2.default.embedSWF(window.WEB_SOCKET_SWF_LOCATION, "webSocketFlash", "1" /* width */
    , "1" /* height */
    , "10.0.0" /* SWF version */
  ...
  if (!window.WEB_SOCKET_DISABLE_AUTO_INITIALIZATION) {
    ...
    _swfobject2.default.addDomLoadEvent(function () {
